...
const heroWords = ["PHOTOGRAPHY", "& VIDEO PRODUCTION"];
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-dark">
      ...
      <div className="container-x relative z-10 text-center">
        ...
        >
          At Bright Media, we capture the essence of your brand with breathtaking photography and 
          videography. Our tailored approach captures your story, elevates your brand, and creates 
          lasting impressions. let’s make your brand shine in every frame.
        </motion.p>
      ...
      >
        {[
          { value: "80+", label: "Session done" },
          { value: "600+", label: "Videos Edited" },
          { value: "1000+", label: "Photos Taken" },
