...
const heroWords = ["Search", "Engine", "Optimization"];
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-dark">
      ...
      <div className="container-x relative z-10 text-center">
        ...
        >
          At Bright Media, we’re committed to elevating your brand through expert SEO services. 
          Our tailored strategies focus on driving organic traffic, boosting search rankings, 
          optimizing performance, and connecting you with the right audience. Let’s make your 
      ...
      >
        {[
          { value: "10K+", label: "Avg Engagement Rate" },
          { value: "99%", label: "Timely Posting Accuracy" },
          { value: "100%", label: "Tailored Content Strategy" },
