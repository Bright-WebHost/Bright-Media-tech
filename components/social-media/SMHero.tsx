...
const heroWords = ["Social", "Media", "Marketing"];
    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-dark">
      ...
      <div className="container-x relative z-10 text-center">
        ...
        <motion.p
          ...
          className="mx-auto mb-5 max-w-2xl text-base leading-relaxed text-white/55 md:text-lg"
        >
          We give your brand a powerful online presence — making genuine connections,
