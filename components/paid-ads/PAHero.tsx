...
const heroWords = ["", "Paid-Ads"];

export default function PAHero() {
    ...
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-dark">
      ...
      <div className="container-x relative z-10 text-center">
        ...
        <motion.p
          ...
          className="mx-auto mb-5 max-w-6xl text-base leading-relaxed text-white/55 md:text-lg"
        >
          At Bright Media, our area of specialization is designing strong sponsored ads to At 
          Bright Media, our area of specialization is designing strong sponsored ads to elevate 
          the online presence of our clients and bring about meaningful outcomes. Consequently, 
          as experts in Meta Ads (Facebook and Instagram) and Google Ads, we pay attention to 
          how much we spend versus what we get out of it by weaving together persuasive commercials 
          that communicate with their precise target audience and always fine-tuning for good 
          performance.
        </motion.p>
      ...
      >
        {[
          { value: "50+", label: "Reaches" },
          { value: "400+", label: "Campaigns" },
          { value: "15+", label: "Lakh Ad Spend" },
          { value: "x3", label: "Growth Impact" },
        ].map((stat) => (
          <div
            key={stat.label}
